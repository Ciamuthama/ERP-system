...
//         let { accountNumber,  memberNo, transactionDate, transactionType, loanAmount, loanBalance, savings, withdrawable, shares, description } = body;

//         //   Validate required fields
//         if (!accountNumber || !memberNo || !transactionDate || !transactionType) {
...
//         const insertQuery = `
//             INSERT INTO fosa (accountNumber, memberNo, transactionDate, transactionType, loanAmount, loanBalance, savings, withdrawable, shares, description) 
//             VALUES (?, ?, ?, ?,?, ?, ?, ?, ?, ?)
//         `;
//         const values = [accountNumber, memberNo, formattedDate, transactionType, loanAmount, loanBalance, savings, withdrawable, shares, description || null];
